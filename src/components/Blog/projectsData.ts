...
const projectsData: Project[] = [
  {
    ...
    githubUrl: "https://github.com/votre-username/expense-tracker",
  ...
  },
  {
    ...
    image: "/images/projects/GestionHotelier.png",
    client: "Projet de fin d'études",
    category: "Gestion hôtelière",
    year: "2025",
    tags: ["Django", "PostgreSQL", "Stripe", "PayPal", "Google Auth", "Bootstrap"],
    githubUrl: "https://github.com/votre-username/hotelia",
    demoUrl: "https://hotelia-demo.vercel.app",
  },
  {
    id: 3,
    ...
    githubUrl: "https://github.com/votre-username/gestionautopro",
    // Pas de démo pour application desktop
  },
];
