...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div className="group shadow-one hover:shadow-xl dark:bg-dark dark:hover:shadow-gray-dark relative overflow-hidden rounded-xl bg-white transition-all duration-300 hover:-translate-y-1">
        <Link
          href="/blog-details"
          className="relative block aspect-37/22 w-full"
        >
          <span className="bg-primary absolute top-6 right-6 z-20 inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-white capitalize shadow-lg">
            {tags[0]}
          </span>
          <Image src={image} alt="image" fill />
        </Link>
        <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-6 xl:py-8 2xl:p-8">
          <h3>
            <Link
              href="/blog-details"
