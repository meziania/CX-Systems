  ...
  return (
    <div className="w-full">
      <div className="wow fadeInUp group rounded-xl bg-white p-8 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:bg-gray-dark" data-wow-delay=".15s">
        <div className="bg-primary/10 text-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-xl transition-all duration-300 group-hover:scale-110 group-hover:bg-primary/20 group-hover:shadow-lg">
          {icon}
        </div>
